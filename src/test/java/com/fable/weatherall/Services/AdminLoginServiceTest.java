...
public class AdminLoginServiceTest {
	  ...
	  @Mock
	    ...
	    @Test
	    void testLoginAdmin_SuccessfulLogin() {
	        // Arrange
	        User user = new User();
	        ...
	        when(userRepo.findOneByEmailAndPassword("admin@example.com", existingUser.getPassword()))
...
//	        existingUser.setPassword("$2a$10$1HJZ3XW7MhNLB7hPQD6qze1Tnp12Sj6TdBxSO4dXbEcZ1/W.jPF1C");
//	        existingUser.setUserType("regular");
//
//	        when(userRepo.findByEmail("user@example.com")).thenReturn(existingUser);
//
//	        // Act
//	        LoginResponse response = userService.loginAdmin(user);
//
//	        // Assert
//	        assertEquals("Email not exists or not an admin", response.getMessage());
//	        assertFalse(response.getStatus());
//	    }
	    @Test
	    void testLoginAdmin_NonAdminUser() {
