...
//		        .requestMatchers("/user/static/**", "/user/static/js/**","/user/static/css/**").permitAll()	
	            ...
	            .requestMatchers("/home","/admin/api/view","/admin/api/config","/admin/api/wapiobj","/admin/api/wview","/comloginn","/forgetPasswordd","/signupp","/aboutt","/submit-feedback").permitAll() 
