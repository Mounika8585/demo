...
//            String storedPassword = user2.getPassword();
//
//            if (passwordEncoder.matches(enteredPassword, storedPassword)) {
//                Optional<User> adm = userRepo.findOneByEmailAndPassword(user.getEmail(), storedPassword);
//                if (adm.isPresent()) {
//                    return new LoginResponse("Login Success", true);
//                } else {
//                    return new LoginResponse("Login Failed", false);
...
//            }
//        } else {
//            return new LoginResponse("Email not exists or not an admin", false);
//        }
//    }
